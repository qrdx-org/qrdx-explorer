...
export default function ShareAddressDialog({ address }: ShareAddressDialogProps) {
  ...
  const shareToTwitter = () => {
    const text = `Check out this QRDX address: ${address}`
  ...
  const shareToWhatsApp = () => {
    const text = `Check out this QRDX address: ${address} ${shareUrl}`
  ...
  const shareToReddit = () => {
    const title = `QRDX Address: ${address}`
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Share this address with others on your preferred platform
          </DialogDescription>
        </DialogHeader>
